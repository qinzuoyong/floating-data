/*
 * 移植自 Shizuku (https://github.com/RikkaApps/Shizuku) manager/src/main/java/moe/shizuku/manager/adb/AdbPairingClient.kt
 * Copyright (C) 2021 RikkaApps
 * Licensed under the Apache License, Version 2.0
 *
 * 适配点:Conscrypt 隐藏 API 直调 → TlsExporter 反射;移除无 native 实现的 available()
 */
...
class AdbPairingClient(private val host: String, private val port: Int, private val pairCode: String, private val key: AdbKey) : Closeable {
    ...
    private fun setupTlsConnection() {
        ...
        val keyMaterial = TlsExporter.exportKeyingMaterial(sslSocket, kExportedKeyLabel, null, kExportedKeySize)
