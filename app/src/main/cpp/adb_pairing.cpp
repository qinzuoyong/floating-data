/*
 * 移植自 Shizuku (https://github.com/RikkaApps/Shizuku) manager/src/main/jni/adb_pairing.cpp
 * Copyright (C) 2021 RikkaApps
 * Licensed under the Apache License, Version 2.0
 *
 * 适配点:JNI 注册类路径改为本项目包名
 */
#include <jni.h>
#include <dirent.h>
#include <cstring>
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    env->RegisterNatives(env->FindClass("com/example/batteryfloat/adb/PairingContext"), methods_PairingContext,
